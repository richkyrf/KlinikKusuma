...
public class Printsupport {
    ...
    public static String title[] = new String[]{"Nama Barang", "Jumlah", "Harga", "Sub Total"};
            ...
            if (pageIndex == 0) {
                ...
                try {
                    ...
                    for (int i = 0; i < mod.getRowCount(); i++) {
                        ...
                        g2d.drawString(NamaBarang, 10, cH);
                        g2d.drawString(Jumlah, 70, cH);
                        g2d.drawString(Harga, 110, cH);
                        g2d.drawString(SubTotal, 150, cH);
                    ...
                    g2d.setFont(font);
                    g2d.drawString("Thank You Come Again", 30, cH + 30);
                    //end of the reciept
                } catch (Exception r) {
                    r.printStackTrace();
                }
