...
public class LaporanStok extends javax.swing.JFrame {
     ...
     */
    public LaporanStok(String type) {
        initComponents();
        setTitle(type);
        setVisible(true);
    ...
    private void jbuttonF1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbuttonF1ActionPerformed
        ...
        hashs.put("PrintedBy", GlobalVar.VarL.username);
        hashs.put("TglAwal", FDateF.datetostr(JDTanggal.getDate(), "yyyy-MM-dd"));
        hashs.put("TglAkhir", FDateF.datetostr(JDTanggal1.getDate(), "yyyy-MM-dd"));
        hashs.put("FormatTglAwal", FDateF.datetostr(JDTanggal.getDate(), "dd/MM/yyyy"));
        hashs.put("FormatTglAkhir", FDateF.datetostr(JDTanggal1.getDate(), "dd/MM/yyyy"));
        FLaporan fLaporan = new FLaporan();
        fLaporan.sethashmap(hashs);
        if (getTitle().equals("Laporan Stok Gudang Kecil")) {
            fLaporan.setfilename("LaporanStokGudangKecil");
            History.simpanhistory(GlobalVar.VarL.username, "Laporan Stok Gudang Kecil");
        } else if (getTitle().equals("Laporan Stok Gudang Besar")) {
            fLaporan.setfilename("LaporanStokGudangBesar");
            History.simpanhistory(GlobalVar.VarL.username, "Laporan Stok Gudang Besar");
        } else {
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        if (getTitle().equals("Laporan Stok Gudang Kecil")) {
            laporanStokGudangKecil = null;
        } else if (getTitle().equals("Laporan Stok Gudang Besar")) {
            laporanStokGudangBesar = null;
        } else {
            System.out.println("Parameter Salah");
        }
